...
data azurerm_resource_group "eventsRg" {
  name = var.resource_group_name
}

resource "azurerm_eventhub_namespace" "events" {
  name                = "${var.name}-ns"
  location            = data.azurerm_resource_group.eventsRg.location
  resource_group_name = data.azurerm_resource_group.eventsRg.name
  sku                 = var.sku
